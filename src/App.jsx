        ...
        <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 14, padding: 16, marginBottom: 14 }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap", fontSize: 12.5, color: C.dim }}>
            ...
            <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
             ...
             {contractor.license === "N/A" ? "License: N/A" : <>License <span onClick={() => { navigator.clipboard?.writeText(String(contractor.license).split(/[,&]/)[0].trim()); onToast("License copied — paste it into DBPR's search box"); window.open("https://www.myfloridalicense.com/wl11.asp?mode=2&search=LicNbr&SID=", "_blank"); }} style={{ color: C.blue, fontWeight: 700, textDecoration: "underline", cursor: "pointer" }}>{contractor.license}</span> · <span onClick={onTrust} style={{ color: C.blue, cursor: "pointer", textDecoration: "underline" }}>verify at FL DBPR</span></>}
