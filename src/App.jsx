...
const makeCss = () => `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 760px) {
    .top-nav { display: none; }     .menu-btn { display: flex; }     .top-actions .btn-ghost { display: none; }     .top-actions .fb-btn { display: inline-flex; font-size: 11px; padding: 6px 10px; line-height: 1.2; text-align: center; }     .post-btn { display: none !important; }     .logo-btn { position: absolute; left: 50%; transform: translateX(-50%); }     .fb-stack { display: inline; }     .hide-mobile-inline { display: none; }     .logo-svg { width: 112px; }
    .bottom-nav {
