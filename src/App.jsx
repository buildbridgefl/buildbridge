...
{ id: "suppliers", icon: "truck", label: "Suppliers" },  
  ...
  <circle cx="700" cy="175" r="7" fill="#FF8A1E" />
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          <button onClick={() => (track("facebook_follow_click", "header"), window.open("https://www.facebook.com/profile.php?id=61591959271748"))} className="btn-ghost" aria-label="BuildBridge FL on Facebook" style={{ padding: "8px 12px", fontSize: 12.5, fontWeight: 800, color: C.blue }}><span className="hide-mobile">Follow us on Facebook</span><Icon name="share" size={16} color={C.blue} className="hide-desktop-inline" /></button> <button onClick={() => (track("facebook_group_click", "header"), window.open("https://www.facebook.com/groups/1454402876451068/"))} className="btn-ghost" aria-label="Citrus County Construction Network Facebook group" style={{ padding: "8px 12px", fontSize: 12.5, fontWeight: 800, color: C.orange }}><span className="hide-mobile">Join the Group</span><Icon name="users" size={16} color={C.orange} className="hide-desktop-inline" /></button> <button onClick={() => setPostModal(true)} className="btn-primary" style={{ padding: "8px 16px", fontSize: 12.5, display: "flex", alignItems: "center", gap: 6 }}>
