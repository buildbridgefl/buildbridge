...
const CONTRACTORS = [
  ...
  { id: 6, hidden: true name: "Alexis Sanchez", company: "BuildBridge LLC", trade: "Project Management", location: "Citrus County, FL", phone: "(352) 555-0100", rating: 5.0, jobs: 0, followers: 0, following: 0, verified: false, premium: true, avatar: "AS", bio: "Project Management for residential builds — overseeing your project from inception to completion. Single point of contact for budget planning, architect coordination, permit management, hiring and vetting builders, construction oversight, and move-in closeout.", specialties: ["Budget Planning", "Permit Management", "Construction Oversight"], license: "N/A", reviews: 0, videoTitle: "BuildBridge FL — Citrus County's Construction Network", videoUrl: "https://www.youtube.com/embed/dTcSJL5hhpY", email: "asanchez@buildbridgefl.com"},
