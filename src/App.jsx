...
const makeCss = () => `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 760px) {
    .top-nav { display: none; }     .menu-btn { display: flex; }     .top-actions .btn-ghost { display: none; }     .top-actions .fb-btn { display: inline-flex; font-size: 11px; padding: 7px 9px; line-height: 1.15; }     .logo-svg { width: 112px; }
    .bottom-nav {
